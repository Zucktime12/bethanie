...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	<div class="form-container">
		...
		<div class="form-navigation">
			<div class="form-navigation__login js-login-nav active">
				<h2><?php _e( 'Login', 'woocommerce' ); ?></h2>
			</div>
			<div class="form-navigation__registration js-registration-nav">
				<h2><?php _e( 'Register', 'woocommerce' ); ?></h2>
			</div>
		</div>

		<div class="form-content">
			<div class="form-content__login js-login-content active">
			...
			<div class="form-content__registration js-registration-content">	
